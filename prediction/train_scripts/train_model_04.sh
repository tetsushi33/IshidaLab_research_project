...
rsync -avht --progress ../../input_label_files/pocket_rmsd_label_seed-1_sqrt.csv $TMPDIR
echo "---------Dataset copied!---------"
...
LABEL_PATH="${TMPDIR}../../input_label_files/pocket_rmsd_label_seed-1_sqrt.csv"
SAVE_DIR="trained_model_checkpoints"

VERSION_NAME="(2)_label_sqrt" # 新しいモデルの学習の際はここも変更する
