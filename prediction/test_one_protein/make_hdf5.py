...
def save_results_to_hdf5(results, output_dir, overwrite=False):
    file_name = "_graph_apo_pocket_binary_15_apo.hdf5"
...
# NumPyのndarrayをPythonの標準のリストに変換する関数
...
if __name__ == "__main__":
    ...
    parser.add_argument('--csv_file', type=str, default="../../input_csv_files/binary_protein_data_split_apo_base.csv")
    #parser.add_argument('--output_dir', type=str, default="../../hdf5_graph_files")
    ...
    # `results`をJSON形式の文字列に変換
    results_json = json.dumps(results, default=convert_to_serializable)

    # `results`をファイルに書き込む
    #with open("output_results.json", "w") as f:
    #    f.write(results_json)

    #print("Results have been saved to output_results.json")
